...
public class AudioService extends Service implements OnCompletionListener, OnPreparedListener, OnErrorListener, OnSeekCompleteListener, OnInfoListener, OnBufferingUpdateListener {
	...
	public static final String BROADCAST_ACTION = "com.example.lection6.seekprogress";

	// Set up broadcast identifier and intent
	public static final String BROADCAST_BUFFER = "com.example.lection6.broadcastbuffer";
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		// Manage incoming phone calls during playback. Pause mp on incoming, resume on hangup.
	...
	private void initNotification() {
		...
		CharSequence tickerText = "Music is playing In Service";
