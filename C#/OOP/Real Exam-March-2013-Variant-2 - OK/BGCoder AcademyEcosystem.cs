...
namespace AcademyEcosystem
{
	...
	public class ExtendedEngine:Engine
    {
        ...
        {
            string organism = commandWords[1];
	...
	public class Boar:Animal,ICarnivore,IHerbivore
    {
        ...
        public Boar(string name, Point location) : base(name, location, boarSize)
        {
            this.biteSize = 2;   
        }
	...
	public class Grass:Plant
    {
		...
		public Grass(Point location):base(location,grassSize)
        {
        }
	...
	public class Wolf:Animal,ICarnivore
    {
		...
		public Wolf(string name, Point location):base(name,location,wolfSize)
        {
        }
	...
	public class Zombie:Animal
    {
		...
		public Zombie(string name, Point location) : base(name, location,zombieSize)
        {
        }
