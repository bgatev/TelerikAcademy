...
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Alphabetical list of products]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Alphabetical list of products];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Category Sales for 1997]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Category Sales for 1997];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Current Product List]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Current Product List];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Customer and Suppliers by City]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Customer and Suppliers by City];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Invoices]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Invoices];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Order Details Extended]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Order Details Extended];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Order Subtotals]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Order Subtotals];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Orders Qry]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Orders Qry];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Product Sales for 1997]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Product Sales for 1997];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Products Above Average Price]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Products Above Average Price];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Products by Category]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Products by Category];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Sales by Category]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Sales by Category];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Sales Totals by Amount]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Sales Totals by Amount];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Summary of Sales by Quarter]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Summary of Sales by Quarter];
GO
IF OBJECT_ID(N'[NorthwindDataModelDataStoreContainer].[Summary of Sales by Year]', 'U') IS NOT NULL
    DROP TABLE [NorthwindDataModelDataStoreContainer].[Summary of Sales by Year];
GO
