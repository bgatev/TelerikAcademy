...
public class ExceptionsHomework
{
    ...
    public static string ExtractEnding(string str, int count)
    {
        if (count > str.Length)
        {
            throw new ArgumentOutOfRangeException("Invalid count! - string must be greater than count");
        }
    ...
    private static void Main()
    {
        ...
        catch (ArgumentOutOfRangeException eRange)
        {
            Console.WriteLine(eRange.Message);
        }
    }
}
